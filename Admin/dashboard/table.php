				...
				<div class="card_body">
					<div class="row d-flex">
						<div class="col-sm-4 createSegment">
							<a class="btn dim_button create_new" href="../Signup"> <span class="glyphicon glyphicon-plus"></span> Create New</a>
						</div>
						...
						<table style="width:100%;" id="filtertable" class="table cust-datatable dataTable no-footer">
							<thead>
								<tr>
									...
									<th style="min-width:150px;">Email Verification</th>
									<th style="min-width:150px;">Action</th>
								</tr>
							</thead>
							<tbody>
								<?php $selectq="select * from auth_data" ; $quary=mysqli_query($con, $selectq); while ($res=mysqli_fetch_array($quary)) { ?>
								<tr>
									<td><?php echo $res['id'] ?></td>
									<td><?php echo $res['username'] ?></td>
									<td><span class="mode mode_process"><?php echo $res['email'] ?></span>
									</td>
									<td><?php echo $res['phone'] ?></td>
									<td><?php $pass = $res['password']; $pcode = str_repeat("*", strlen($pass)); echo $pcode ?></td>
									<td><?php $status = $res['status']; if($status == 'verified'){?><span class="mode mode_on">verified</span>
									<?php }elseif($status == 'notverified'){?><span class="mode mode_off">Not Verified</span><?php }else{ ?><span class="mode mode_none">Not Defined</span><?php } ?>
									</td>
									<td>
										<div class="btn-group">
											<a class="dropdown_icon" href="Update-user-info/<?php echo $res['id'] ?>"> <i class="bi bi-pencil-square"></i> 
											</a>
										</div>
										<div class="btn-group">
                                 <a class="dropdown_icon" href="#"><i class="bi bi-envelope"></i></a>
										...
										<div class="btn-group">
											...
											<ul class="dropdown-menu dropdown_more">
												...
												<li>
													<a href="Delete-User/<?php echo $res['id'] ?>" target="_black"> <i class="bi bi-trash"></i> Delete</a>
												</li>
												<li>
